      ...
      >
        ...
        <b-container fluid>
          ...
          <b-col>
            <b-row class="email" >
              <b-col sm="1"></b-col>
              <b-col sm="10"  style="width:300px; magin-bottom:20px">
                <b-form-input  id=" input input-email" placeholder="Your Email Address" v-model="form.email" required></b-form-input>
              </b-col>
              <b-col sm="1"></b-col>
            </b-row>
            ...
            <b-row class="passwd">
              ...
              <b-col sm="10" style="width:300px">
                <b-form-input id="input input-password" placeholder="Your Password" v-model="form.password" required></b-form-input>
              </b-col>
              <b-col sm="1"></b-col>
            </b-row>
          </b-col>
          ...
          <!-- checkbox -->
          <b-col sm="8" style="margin:10px 0px 10px 0px;">
            <b-check class="check-passwd" >Remember Password</b-check>
          </b-col>
        </b-container>
        
        <!-- 操作按钮 -->
        <b-col bg-variant="light" id="btn-card">
